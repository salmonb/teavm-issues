package teavmissue.json.providers.teavm;

import teavmissue.json.spi.ElementType;
import teavmissue.json.spi.WritableJsonElement;
 ...
 * @author Bruno Salmon
 */
public abstract class TeaVmJsonElement implements WritableJsonElement {
